...
public class Practice14MaskFilterView extends View {
    ...
    Bitmap bitmap;
    BlurMaskFilter normal = new BlurMaskFilter(50, BlurMaskFilter.Blur.NORMAL);
    BlurMaskFilter inner = new BlurMaskFilter(50, BlurMaskFilter.Blur.INNER);
    BlurMaskFilter outer = new BlurMaskFilter(50, BlurMaskFilter.Blur.OUTER);
    BlurMaskFilter solid = new BlurMaskFilter(50, BlurMaskFilter.Blur.SOLID);
